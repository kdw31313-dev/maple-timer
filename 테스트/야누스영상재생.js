...
const result = spawnSync('ffmpeg', ['-v','error','-i',process.argv[2],'-vf',`fps=20/9,crop=${width}:${height}:1056:0:exact=1`,'-f','rawvideo','-pix_fmt','rgba','pipe:1'], { maxBuffer: 256 * 1024 * 1024 });
