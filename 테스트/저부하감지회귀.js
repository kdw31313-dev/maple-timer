...
assert.doesNotMatch(화면분석코드, /processJanusTemplateFrame|processExpTemplateFrame|janusCanvas|toggle-janus-detection/);
...
console.log('✅ 저부하 감지 회귀 통과: 룬/거탐 주기 유지, 야누스 감지 코드 완전 제거 확인');
